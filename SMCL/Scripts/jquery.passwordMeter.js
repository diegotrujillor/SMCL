...
**    By: Diego Fernando Trujillo
**    Desc: Engage script to minimal functionality in a web application. Re-dist scores.
**
**    License Information:
**    -------------------------------------------------------------------------
...
function chkPass(pwd) {
	...
	var oMinPasswordUpperCaseLetters = $("minPasswordUpperCaseLetters");
	var oMinPasswordLowerCaseLetters = $("minPasswordLowerCaseLetters");
	var oMinPasswordNumerics = $("minPasswordNumerics");
	var oMinPasswordSymbols = $("minPasswordSymbols");
	...
	var nMultLength=4, nMultNumber=6;
	var nMultSymbol=8;
...
//		/* Point deductions for poor practices */
		...
		if (nScore >= 0 && nScore < 20) { sComplexity = "Muy D\xE9bil"; }
		else if (nScore >= 20 && nScore < 40) { sComplexity = "D\xE9bil"; }
		else if (nScore >= 40 && nScore < 60) { sComplexity = "Aceptable"; }
		...
		oMinPasswordUpperCaseLetters.setAttribute("value", nAlphaUC);
		oMinPasswordLowerCaseLetters.setAttribute("value", nAlphaLC);
		oMinPasswordNumerics.setAttribute("value", nNumber);
		oMinPasswordSymbols.setAttribute("value", nSymbol);
