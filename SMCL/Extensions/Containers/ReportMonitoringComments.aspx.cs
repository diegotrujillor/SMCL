...
{
    public partial class ReportMonitoringComments : System.Web.UI.Page
    {
        ...
        protected void odsMonitoring_DataBinding(object sender, EventArgs e)
        {
            ...
            logList.Add(log.GetNewLog(ConfigurationManager.AppSettings["ReportText"] + "Texto con comentarios de usuario", (int)EventTypes.Report, (int)Session["UserId"]));
            log.Write(logList);
        }
    }
}