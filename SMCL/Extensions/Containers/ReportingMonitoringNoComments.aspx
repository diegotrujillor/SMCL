<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportingMonitoringNoComments.aspx.cs" Inherits="SMCL.Extensions.Containers.ReportingMonitoringNoComments" %>
			...
			<div class="report_filters_div">
				<table id="report_table_filters">
					...
					<tr>
						...
						<td>
							<asp:DropDownList ID="ddlAppliances" runat="server" AppendDataBoundItems="True" 
				...
				<LocalReport ReportPath="Content\Reports\Report_Data_Signals_NoComments.rdlc">
					<DataSources>
