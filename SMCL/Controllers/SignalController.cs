    ...
    public class SignalController : Controller
    {
        ...
        public ActionResult Create(Signal signal, FormCollection form)
        {
            ...
            if (this.FormCollectionIsValid(form))
            {
                ...
                logList.Add(log.GetNewLog(ConfigurationManager.AppSettings["CreateText"] + ControllerContext.RouteData.Values["controller"] + "(Id=" + signal.Id + ")", (int)EventTypes.Create, (int)Session["UserId"]));
                log.Write(logList);
        ...
        public ActionResult Edit(Signal signal, FormCollection form)
        {
            ...
            if (this.FormCollectionIsValid(form))
            {
                ...
                List<Object> logList = new List<Object>();
                logList.Add(log.GetNewLog(ConfigurationManager.AppSettings["EditText"] + ControllerContext.RouteData.Values["controller"] + "(Id=" + signal.Id + ")", (int)EventTypes.Edit, (int)Session["UserId"]));
                log.Write(logList);
